...
const CategoryProductList = ({
  ...
  const slicedCategory = categoryMainList.slice(firstPostIndex, lastPostIndex);
  const mappedCategoryList = slicedCategory.map((product) => (
    <div
    ...
    >
      <div className=" bg-re-300  relative  flex h-[60vw] max-h-[400px] items-center    shadow-sm after:absolute after:top-0 after:h-[0%]  after:w-[100%] after:bg-gray-950 after:opacity-75  after:transition-all after:duration-500 after:ease-in-out group-hover:after:h-[100%] md:h-[40vw] ">
        ...
        <div className="absolute top-1 z-10 ml-[-100px] flex w-[0%] flex-col  gap-y-2 transition-all duration-500 ease-in-out group-hover:ml-[0px] group-hover:w-[70%] ">
          <button className="text  md:text-[10px flex items-center gap-x-1 border  border-none bg-[#5a9bc1]  p-2 text-[12px] text-white  outline-none">
            <FiShoppingBag color="white" size={15} className="" />
            <p>Cart</p>
          </button>
          <button className="text  md:text-[10px flex items-center gap-x-1 border  border-none bg-[#c15a5a]  p-2 text-[12px] text-white  outline-none">
            <FaRegHeart color="white" size={15} className="" />
            <p>Wish List</p>
          </button>
          <button className="text  md:text-[10px flex items-center gap-x-1 border  border-none bg-slate-300 p-2 text-[12px] font-bold  outline-none">
